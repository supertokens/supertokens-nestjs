...
export interface SuperTokensModuleOptionsFactory {
    createSuperTokensModuleOptions(): Promise<SuperTokensModuleOptions> | SuperTokensModuleOptions;
}
export interface SuperTokensModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
    global?: boolean;
